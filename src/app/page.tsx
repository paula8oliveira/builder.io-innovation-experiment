...
const MyComponent: React.FC = () => {
  return (
    <section className="pl-20 h-screen bg-neutral-100 max-md:p-0 max-md:flex-col-reverse">
      <div className="flex gap-5  bg-neutral-100 max-md:gap-0 max-md:flex-col-reverse">
        <section className="flex flex-col w-[37%] max-md:ml-0 max-md:w-full max-md:py-20 max-md:px-5 ">
          <form className="flex flex-col self-stretch p-8 my-auto w-full bg-white rounded border border-solid border-slate-300 max-md:px-5 max-md:mt-0">
            <h2 className=" text-h5 font-medium leading-9 text-basics-ink">
              Sign in
            </h2>
        ...
        <aside className="flex flex-col ml-5 w-[63%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow justify-center align-center px-20 py-16 w-full h-screen bg-blue-500 max-md:px-5  max-md:max-w-full">
            <div className="mx-5 text-h3 font-medium text-neutral-300 leading-[68.16px] max-md:mt-10 max-md:mr-2.5 max-md:max-w-full max-md:text-4xl">
              Welcome.
            </div>
            <div className="mx-5 mt-4 text-h6 font-bold tracking-normal leading-7 text-neutral-300 max-md:mr-2.5 max-md:max-w-full">
